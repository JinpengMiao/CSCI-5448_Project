...
/**
 * @author jinpeng
 * create a window on which admin can change customers: add or delete
 */
public class ChangeCustomer extends JFrame implements ActionListener
{
    ...
    public ChangeCustomer(){
    	...
    	//set label
    	l1 = new JLabel("Change Customer");
        l1.setForeground(Color.blue);
        l1.setFont(new Font("Serif", Font.BOLD, 30)); 
    	
    	//set buttons
        button1 = new JButton("Add New Customer");
        button2 = new JButton("Delete Customer");
