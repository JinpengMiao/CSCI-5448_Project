...
/**
 * @author jinpeng
 * create a registration page for new users to sign up
 *
 */
public class Register extends JFrame implements ActionListener {
    ...
    /**
     * create four text boxes for user information
     */
    JTextField usernameText, emailText, phoneNumText, addressText;
    /**
     * create one button to register
     */
    JButton register;
    /**
     * create two password text boxes to make sure the passwords users set are correct
     */
