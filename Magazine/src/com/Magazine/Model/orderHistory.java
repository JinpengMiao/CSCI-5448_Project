...
/**
 * @author jinpeng
 * This class contains all the magazine information of order history
 */
public class orderHistory {
     ...
     */
    public orderHistory(String type, String name, String date, String decorator, Double price) {
    	this.type=type;
    	this.name=name;
    	this.date=date;
